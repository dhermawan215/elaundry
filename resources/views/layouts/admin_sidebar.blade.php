    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html"> Logout </a>
                    <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html"> Setting </a>
                    <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html"> Changes Password </a>
                    </li>
                </ul>
            </div>
        </li>
